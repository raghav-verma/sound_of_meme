...
class _YourLibraryWidgetState extends State<YourLibraryWidget> {
  ...
  void initState() {
    ...
    context.read<HomeBloc>().add(GetUserSongsEvent(page: _currentPage));
    super.initState();
  }
                  ...
                  return NotificationListener<ScrollNotification>(
                    ...
                    child: RefreshIndicator(
                      ...
                      onRefresh: () async {
                        ...
                        context
                            .read<HomeBloc>()
                            .add(GetUserSongsEvent(page: _currentPage));
                      },
  ...
  void _selectSong(final int index) {
    ...
    context.read<CurrentSongCubit>().updateSong(_songListNotifier.value[index]);
